...
const HeroSection = () => {
  return (
    <section className="flex flex-col items-center justify-center">
      <div className="flex flex-col-reverse md:flex-row gap-36 items-center justify-center px-8 py-16 md:py-24 lg:py-32 space-x-6 text-white max-w-[75rem]">
        <div className="w-full md:w-3/5 ">
          ...
          <p className="font-montserrat font-medium text-lg md:text-2xl lg:text-2xl pt-8 md:pt-12 lg:pt-16">
            We are BLASTing off soon with Dynamyte Launchpad{"'"}s Explosive
            IDO!
          </p>
